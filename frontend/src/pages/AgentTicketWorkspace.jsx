...
const AgentTicketWorkspace = () => {
  ...
  if (!ticket) {
    return <Typography sx={{ p: 4 }}>Ticket not found.</Typography>;
  }

  const isSLABreached =
    ticket.due_date && new Date() > new Date(ticket.due_date);
    ...
    <Box sx={{ display: 'flex', height: '100vh', bgcolor: '#f1f5f9' }}>
      <Grid container spacing={0}>
          ...
          <Stack spacing={3} sx={{ mt: 2 }}>
            ...
            <Box>
              ...
              <Chip
                label={ticket.status}
                size="small"
                sx={{ ml: 2, bgcolor: '#0D9488', color: 'white', fontWeight: 900 }}
              />
            </Box>
            ...
            >
              <Typography variant="caption" fontWeight={900} color="#c53030">
                SLA DEADLINE
              </Typography>
              ...
              {isSLABreached && (
                <Chip
                  ...
                  size="small"
                  color="error"
                  sx={{ mt: 1, fontWeight: 900, fontSize: 10 }}
                />
              )}
            </Box>
        ...
        >
          ...
          <List>
            <ListItemText
              primary="Previous ticket: #TK-1122"
              secondary="Resolved 4 days ago"
            />
          </List>
        </Grid>
